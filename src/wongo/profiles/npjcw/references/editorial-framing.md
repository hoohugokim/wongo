# npj Clean Water editorial framing

Source: [Aims & Scope](https://www.nature.com/npjcleanwater/aims), fetched
and read in full 2026-07-04.

## What the journal says it wants

Verbatim: "npj Clean Water considers research that explores all aspects of
the sustainable supply of clean water." Explicitly listed topics (not
exhaustive — "including but not limited to"):
- Drinking water and wastewater treatment by physical, chemical, or
  biological means.
- New materials and process technologies for water/wastewater treatment,
  water production, and water-resource recovery, including nanotechnologies
  and integrated nanostructured materials.
- Desalination of seawater, groundwater, and non-traditional wastes for
  recycling or reuse.
- Renewable energy integrated with water treatment technologies.
- Advances in measurement/detection of regulated water-quality parameters,
  including real-time monitoring of pathogens and emerging contaminants.
- Software and hardware innovations for reliable, efficient clean-water
  distribution and supply.
- Smart water systems for generation, delivery, and usage monitoring.

Positioning: "The journal offers more choice to Nature Portfolio authors
who are seeking a fully open-access and more inclusive platform for
publishing their work," led by "clean water experts," and part of the npj
...
- No stated novelty/significance rubric was found in the fetched Aims &
  ...
  language) — Editorial policies' general Nature Portfolio criteria (novel,
  reproducible, adequately powered, ethically sound) apply by default;
...
Mine recent npj Clean Water editorials, if any exist, and Editor-in-Chief
public statements for sharper novelty/impact framing — none were found
during this verification pass; the Content types and Aims & Scope pages
carry no editorial commentary beyond structural formatting guidance.
